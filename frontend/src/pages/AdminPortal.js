                      ...
                      <td className="px-3">
                        {p.status === 'PENDING' ? (
                          <button
                            ...
                            style={{ background: 'linear-gradient(135deg, #059669, #10b981)', color: 'white', borderRadius: 8, fontSize: '0.78rem', whiteSpace: 'nowrap', border: 'none', boxShadow: '0 2px 8px rgba(16,185,129,0.3)' }}>
                            {verifying === p.id ? (
                              <><span className="spinner-border spinner-border-sm me-1"></span>Sending…</>
                            ) : (
                              <><i className="bi bi-check2-circle me-1"></i>Verify & Send</>
                            )}
                          </button>
                        ) : (
                          <span className="text-secondary" style={{ fontSize: '0.75rem' }}>
